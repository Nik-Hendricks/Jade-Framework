...
class ManageLeagueApplicantsView extends View{
    constructor(){
        super();
    }
...
window.customElements.define('manage-league-applicants-view', ManageLeagueApplicantsView);
export{ManageLeagueApplicantsView};